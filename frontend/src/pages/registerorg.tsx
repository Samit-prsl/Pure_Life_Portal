    ...
    <div className='flex-[4] bg-gray-300 min-h-screen lg:pl-10'>
      <div className=' py-14 px-4'>
        ...
        <p className=' lg:text-xl text-lg font-poppins text-rose-700 py-2'>Please register your organization first.</p>
            ...
            <div className=' py-2'>
                <button className={` px-5 py-2 bg-sky-700 text-rose-950 font-poppins lg:w-[60%] w-full hover:bg-sky-500 ${Loading ? `opacity-50 cursor-wait`:``}`} onClick={handlesubmit}>Register</button>
            </div>
            <div className=' py-3'>
            <p className=' text-sky-800 font-cinzel text-xl '>Registered? <Link href='/loginorg' className=' text-rose-800'>Login now!</Link></p>
            </div>
      </div>
    </div>
